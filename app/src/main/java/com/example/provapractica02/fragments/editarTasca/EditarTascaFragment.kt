package com.example.provapractica02.fragments.editarTasca
...
import com.example.provapractica02.fragments.tasques.TasquesRepository
...
class EditarTascaFragment : Fragment() {
    ...
    private fun setupSpinners() {
        ...
        val adapterEstat = ArrayAdapter(
            requireContext(), android.R.layout.simple_spinner_item, estats
        )
